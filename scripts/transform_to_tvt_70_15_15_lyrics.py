...
def transform_to_tvt_70_15_15_lyrics():
    """
    Transforma os 6 ficheiros CSV individuais de lyrics num único ficheiro consolidado
    ...
    output_path = r"c:\Users\aluno23155\Desktop\ProjetoBigData23155\metadata\splits\lyrics\tvt_70_15_15.csv"
    
    # Definir os ficheiros CSV de origem
    csv_files = {
        'balanced_test': 'tvt_70_15_15_test_lyrics_balanced.csv',
        'balanced_train': 'tvt_70_15_15_train_lyrics_balanced.csv', 
        'balanced_validate': 'tvt_70_15_15_validate_lyrics_balanced.csv',
        'complete_test': 'tvt_70_15_15_test_lyrics_complete.csv',
        'complete_train': 'tvt_70_15_15_train_lyrics_complete.csv',
        'complete_validate': 'tvt_70_15_15_validate_lyrics_complete.csv'
    }
    ...
    print("Iniciando transformação para tvt_70_15_15 (lyrics)...")
...
if __name__ == "__main__":
    transform_to_tvt_70_15_15_lyrics()
